...
public class CpcredoDbContext : DbContext
{
    ...
    private static void ConfigureMembers(ModelBuilder modelBuilder, bool npgsql)
    {
        ...
        modelBuilder.Entity<SavingsProduct>(b =>
        {
            ...
            b.Property(x => x.Name).HasMaxLength(128).IsRequired();
            b.Property(x => x.CurrencyCode).HasMaxLength(3).IsRequired();
            b.Property(x => x.ProductKind).HasConversion<string>().HasMaxLength(16);
            b.Property(x => x.InterestMethod).HasConversion<string>().HasMaxLength(32);
            b.Property(x => x.InterestRatePercent).HasPrecision(MoneyAmount.Precision, MoneyAmount.Scale);
            b.Property(x => x.MinOpeningAmount).HasPrecision(MoneyAmount.Precision, MoneyAmount.Scale);
            b.Property(x => x.MinimumBalance).HasPrecision(MoneyAmount.Precision, MoneyAmount.Scale);
            b.Ignore(x => x.DisplayName);
            b.Ignore(x => x.IsTermLike);
        ...
        modelBuilder.Entity<SavingsAccount>(b =>
        {
            ...
            b.Property(x => x.CurrencyCode).HasMaxLength(3).IsRequired();
            b.Property(x => x.MinimumBalance).HasPrecision(MoneyAmount.Precision, MoneyAmount.Scale);
            b.Property(x => x.MaturesOn);
            b.Property(x => x.AllowWithdrawBeforeTerm);
