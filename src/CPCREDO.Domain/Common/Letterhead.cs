...
public static class Letterhead
{
    ...
    public const string Line2 = "Caisse Populaire Épargne et de Crédit";
    public const string Line3 = "pour le Développement de l’Ouest";
    public const string Line4 = "Pétion-Ville, Haïti";
    public const string LegalName = "Caisse Populaire Épargne et de Crédit pour le Développement de l’Ouest";
    ...
    public const string Footer =
        "CPCREDO — Caisse Populaire Épargne et de Crédit pour le Développement de l’Ouest — Pétion-Ville, Haïti";
}
